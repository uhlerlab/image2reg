...
echo "Running Image2Reg inference pipeline for JUN..." | fold -sw 80
echo "---------------------------------------------------" | fold -sw 80
echo ""

echo "Preprocess chromatin images..." | fold -sw 80
echo "The output will be saved in the directory demo/JUN/images/preprocessed." | fold -sw 80
echo
...
echo "The image embeddings for the chromatin images of the nuclei from the JUN condition will be saved as test_latents.h5 in the directory demo/JUN/embeddings." | fold -sw 80
echo ""
