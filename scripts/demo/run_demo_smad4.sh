...
echo "Running Image2Reg inference pipeline for SMAD4..."
echo ""

echo "Preprocess chromatin images..."
echo "The output will be saved in the directory demo/SMAD4/images/preprocessed."
...
echo "The image embeddings for the chromatin images of the nuclei from the SMAD4 condition will be saved as test_latents.h5 in the directory demo/SMAD4/embeddings."
echo ""
