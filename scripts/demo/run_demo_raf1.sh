...
echo "Running Image2Reg inference pipeline for RAF1..."
echo ""

echo "Preprocess chromatin images..."
echo "The output will be saved in the directory demo/RAF1/images/preprocessed."
...
echo "The image embeddings for the chromatin images of the nuclei from the RAF1 condition will be saved as test_latents.h5 in the directory demo/RAF1/embeddings."
echo ""
