---
title: 'Enrichment analysis of the gene clusters in the image-based gene embedding space'
author: "Daniel Paysan"
date: "06/07/2022"
output: html_document
---

This notebook conducts a GO analysis to characterize the gene clusters identified in the image-based gene embedding space.
...
First, we install or load the required packages.

Please skip the following code chunk if the packages in the next one are already installed.
...
Please make sure that the versions of the installed packages match those we have used to ensure reproducibility of the results.
The version numbers are given in the output of the following cell.
...
```{r}
#save.image(file = "other/gene_pert_go_analyses.Rdata")
sessionInfo()
```
