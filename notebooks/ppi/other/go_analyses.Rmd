...
```{r}
all_genes <- c('AKT1S1', 'ATF2', 'ATF4', 'BAX', 'BCL2L11', 'BRAF', 'CASP8', 'CDC42', 'CDKN1A', 'CEBPA', 'CREB1', 'CXXC4', 'DIABLO', 'E2F1', 'EIF4EBP1', 'ELK1', 'EMPTY', 'ERG', 'HRAS', 'IKBKB', 'IRAK4', 'JUN', 'MAP2K3', 'MAP3K2', 'MAP3K5', 'MAP3K9', 'MAPK7', 'MKNK1', 'MYD88', 'PKIA', 'PRKACA', 'PRKCE', 'RAF1', 'RELB', 'RHOA', 'SDHA', 'SMAD4', 'SRC', 'SREBF1', 'STK3', 'TSC2', 'WWTR1')

selected_genes <- c('CEBPA', 'ERG', 'JUN')
```
